package com.billion_dollor_company.Bank_Server.util.helpers;
...
public class HelperXML {
    public static String extract(String xmlCode, String tagToExtract) {
        try {
    ...
    public static HashMap<String, String> convertXmlToMap(String xmlCode, String[] toExtractArr) {
    ...
    public static String convertMapToXml(Map<String, String> map, String rootName) {
        try {
