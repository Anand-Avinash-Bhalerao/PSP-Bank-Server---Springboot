...
public class PSPController {
    ...
    public ResponseEntity<String> initiateTransaction(@RequestBody String jsonReqStr) {
        ...
        try {
            ...
            return new ResponseEntity<>(statusObj.toString(), HttpStatus.BAD_REQUEST);
        }
        ...
        try {
            responseForAppObj = jsonMapper.readValue(responseFromNPCI.getBody(), ResponseStatusInfo.class);
        ...
        System.out.println("The response being sent from PSP to App in JSON is " + Helper.getPrettyJson(responseForAppStr));
